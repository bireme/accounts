...
urlpatterns = patterns('',
     ...
     url(r'^password/reset/$', auth_views.password_reset, { 'template_name': "registration/password-reset.html", 'email_template_name': 'registration/password_reset_email.html'}, name='auth_password_reset'), 
