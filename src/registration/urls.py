...
urlpatterns = [
    ...
    path('password/reset/', registration_views.PasswordResetView.as_view(template_name='registration/password-reset.html', email_template_name='registration/password_reset_email.html'), name='auth_password_reset'),
    path('password/reset/confirm/<uidb64>/<token>/', registration_views.PasswordResetConfirmView.as_view(template_name='registration/password-reset-confirm.html'), name='auth_password_reset_confirm'),
